namespace Calico
{
    public static class DefaultArgDescriptions
    {
        ...
        public const string PlotId =
            @"The id of the plot that the data is associated with";

        public const string FeatureTypeId =
            @"The id of the feature type that describes the meta data";

        public const string Shapefile =
            @"The shapefile to pull data from";

        public const string TargetDataSet =
            @"The id of the data set that is going to be refreshed";
